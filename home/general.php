<?php
session_start();
if (isset($_SESSION['quenogen'])){
$quesno=$_SESSION['quenogen'];
$ques=$_SESSION['genqn'];
$ans=$_SESSION['genans'];
}else{
...
<tr><td><a href="delque.php"><button type="submit" class="btn btn-primary" name="final">Done</button></a></td>
<td><a href="home.php#work-section"><button type="submit" class="btn btn-primary" name="final">Dismiss</button></a></td>
</tr>
  </div>   
</div>
