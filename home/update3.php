...
$quesno=$_POST['queno'];
$sql = "DELETE FROM final WHERE Question_no=$quesno";
...
$sql = "SELECT * FROM final WHERE Question_no=$quesno";
...
if(isset($_POST['que']) && isset($_POST['ans'])){
      ...
      $ansss=$_POST['ans'];
      $num=$_SESSION['quesno'];
$sql = "UPDATE final SET Question='$quesss',Answer='$ansss' Where Question_no='$num'";
if (mysqli_query($conn, $sql)) {
  echo '<div class="alert alert-success">
    ...
    <a href="fnl_all.php"><button type="submit" class="btn btn-primary">Back</button></a>
