...
$quesno=$_POST['queno'];
$sql = "DELETE FROM general WHERE Question_no=$quesno";
...
$sql = "SELECT * FROM general WHERE Question_no=$quesno";
...
if(isset($_POST['que']) && isset($_POST['ans'])){
      ...
      $ansss=$_POST['ans'];
      $num=$_SESSION['quesno'];
$sql = "UPDATE general SET Question='$quesss',Answer='$ansss' WHERE Question_no='$num'";
if (mysqli_query($conn, $sql)) {
  echo '<div class="alert alert-success">
    ...
    <a href="gen_all.php"><button type="submit" class="btn btn-primary">Back</button></a>
