...
$quesno=$_POST['queno'];
$sql = "DELETE FROM audiovisual WHERE Question_no=$quesno";
...
if(isset($_POST['que']) && isset($_POST['ans'])){
      ...
      $ansss=$_POST['ans'];
      $num=$_SESSION['quesno'];
$sql = "UPDATE audiovisual SET Question='$quesss',Answer='$ansss' Where Question_no='$num'";
if (mysqli_query($conn, $sql)) {
  echo '<div class="alert alert-success">
    ...
    <a href="aud_all.php"><button type="submit" class="btn btn-primary">Back</button></a>
